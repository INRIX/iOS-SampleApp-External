/*
 * @header IXCLParkingLotsInBoxOptions.h
 ...
 * @abstract
 *      Represents request parameters for retrieving parking lots in a rectangular
 *      region.
 */
@interface IXCLParkingLotsInBoxOptions : IXCLParkingLotBaseOptions <NSCopying>
