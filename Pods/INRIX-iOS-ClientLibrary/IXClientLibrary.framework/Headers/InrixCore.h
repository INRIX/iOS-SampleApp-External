...
/*!
 * @abstract
 *      The speed limit controller to be used.
 * @discussion
 *      The speed limit controller provides functionality for requesting
 *      speed limit information.  This controller is created the first
 *      time the property is referenced.
 */
@property (nonatomic, strong, readonly) id<IXCLSpeedLimitControllerProtocol> speedLimitController;
