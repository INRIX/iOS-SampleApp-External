...
typedef NS_ENUM (NSUInteger, IXCLIncidentType)
{
    ...
    IXCLIncidentTypeLaneClosure     = 1002,
};
...
/*!
 * @abstract Corresponds to the `coordinate` property of an incident server response.
 */
@property (nonatomic, assign, readwrite) CLLocationCoordinate2D serverCoordinate;
